...
from app.models.models import User, Cart, CartItem, Category, Product  # Explicitly import models
...
target_metadata = Base.metadata  # Use Base's metadata to detect models
...
# Determine the mode and execute the corresponding migration function
